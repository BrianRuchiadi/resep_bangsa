					        ...
					        <div class="report modal-content">
					        	<form method="post" action="{{ url('/laporan/bahan-makanan') }}">
					         	{{ csrf_field() }}
					          		<table>
					           			<tr>
					            			<td colspan="2"><h1> Melaporkan Makanan "{{ $food->name }}"</h1></td>
					           			</tr>
					           			@if(count($errors) > 0)
					           			<tr>
